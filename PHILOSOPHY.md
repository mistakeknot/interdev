...
## North Star
Advance interdev through small, testable changes aligned to its core mission: Developer tooling for Claude Code — MCP CLI interaction, skill authoring, plugin development, and Claude Code reference.
